...
Local ancestry is provided by ancestry windows for all individuals in the CRELES cohort. Each window is defined in the file by chromosome, start position and end position (chr, spos, epos). For each sample, both haplotypes ancestries are reported with the notation (ID.0 / ID.1). 

**PATH: ~/KoborLab/kobor_space/ppascualli/Files/CRELES/0_MainFiles/ancestryFiles/gnomix_CRELES.msp.tsv**
